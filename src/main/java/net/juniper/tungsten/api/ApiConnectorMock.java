...
public class ApiConnectorMock implements ApiConnector {
    ...
    private static Class<?extends ApiObjectBase> getVncClass(String clsname) {
        ...
        try {
            Class<?extends ApiObjectBase> cls = (Class<?extends ApiObjectBase>)Class.forName("net.juniper.tungsten.api.types." + typename);
            return cls;
        } catch (Exception e) {
            s_logger.debug("Class not found <net.juniper.tungsten.api.types." + typename + ">" + e);
        }
        return null;
    }
