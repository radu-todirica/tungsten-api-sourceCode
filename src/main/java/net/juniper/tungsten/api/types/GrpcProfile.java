...
public class GrpcProfile extends ApiObjectBase {
    private Boolean grpc_profile_is_default;
    private GrpcParameters grpc_parameters;
    ...
    public Boolean getIsDefault() {
        return grpc_profile_is_default;
    }
    
    public void setIsDefault(Boolean grpc_profile_is_default) {
        this.grpc_profile_is_default = grpc_profile_is_default;
    }
    ...
    public void setGrpcParameters(GrpcParameters grpc_parameters) {
