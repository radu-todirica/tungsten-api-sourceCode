...
public class SflowProfile extends ApiObjectBase {
    private Boolean sflow_profile_is_default;
    private SflowParameters sflow_parameters;
    ...
    public Boolean getIsDefault() {
        return sflow_profile_is_default;
    }
    
    public void setIsDefault(Boolean sflow_profile_is_default) {
        this.sflow_profile_is_default = sflow_profile_is_default;
    }
    
    
    public SflowParameters getSflowParameters() {
        return sflow_parameters;
    }
    
    public void setSflowParameters(SflowParameters sflow_parameters) {
        this.sflow_parameters = sflow_parameters;
    }
