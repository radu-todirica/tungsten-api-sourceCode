...
public class BgpRouter extends ApiObjectBase {
    ...
    private List<ObjectReference<ApiPropertyBase>> control_node_zone_refs;
    ...
    public List<ObjectReference<ApiPropertyBase>> getControlNodeZone() {
        return control_node_zone_refs;
    }

    public void setControlNodeZone(ControlNodeZone obj) {
        control_node_zone_refs = new ArrayList<ObjectReference<ApiPropertyBase>>();
        control_node_zone_refs.add(new ObjectReference<ApiPropertyBase>(obj.getQualifiedName(), null, null, obj.getUuid()));
    }
    
    public void addControlNodeZone(ControlNodeZone obj) {
    ...
    public void removeControlNodeZone(ControlNodeZone obj) {
        if (control_node_zone_refs != null) {
            control_node_zone_refs.remove(new ObjectReference<ApiPropertyBase>(obj.getQualifiedName(), null));
        }
    }
