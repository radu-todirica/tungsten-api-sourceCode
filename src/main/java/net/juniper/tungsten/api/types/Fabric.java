...
public class Fabric extends ApiObjectBase {
    ...
    public void setVirtualNetwork(VirtualNetwork obj, FabricNetworkTag data) {
        ...
        virtual_network_refs.add(new ObjectReference<FabricNetworkTag>(obj.getQualifiedName(), data, null, obj.getUuid()));
    }
    ...
    public void setNodeProfile(NodeProfile obj, SerialNumListType data) {
        ...
        node_profile_refs.add(new ObjectReference<SerialNumListType>(obj.getQualifiedName(), data, null, obj.getUuid()));
    }
