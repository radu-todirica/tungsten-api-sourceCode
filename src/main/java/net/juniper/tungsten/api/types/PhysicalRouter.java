...
public class PhysicalRouter extends ApiObjectBase {
    ...
    public void setFabric(Fabric obj) {
        ...
        fabric_refs.add(new ObjectReference<ApiPropertyBase>(obj.getQualifiedName(), null, null, obj.getUuid()));
    }
    ...
    public void setNodeProfile(NodeProfile obj) {
        ...
        node_profile_refs.add(new ObjectReference<ApiPropertyBase>(obj.getQualifiedName(), null, null, obj.getUuid()));
    }
    ...
    public void setDeviceFunctionalGroup(DeviceFunctionalGroup obj) {
        ...
        device_functional_group_refs.add(new ObjectReference<ApiPropertyBase>(obj.getQualifiedName(), null, null, obj.getUuid()));
    }
    ...
    public void setDeviceChassis(DeviceChassis obj) {
        ...
        device_chassis_refs.add(new ObjectReference<ApiPropertyBase>(obj.getQualifiedName(), null, null, obj.getUuid()));
    }
    ...
    public void setDeviceImage(DeviceImage obj) {
        ...
        device_image_refs.add(new ObjectReference<ApiPropertyBase>(obj.getQualifiedName(), null, null, obj.getUuid()));
    }
    ...
    public void setPhysicalRole(PhysicalRole obj) {
        ...
        physical_role_refs.add(new ObjectReference<ApiPropertyBase>(obj.getQualifiedName(), null, null, obj.getUuid()));
    }
    ...
    public void setOverlayRole(OverlayRole obj) {
        ...
        overlay_role_refs.add(new ObjectReference<ApiPropertyBase>(obj.getQualifiedName(), null, null, obj.getUuid()));
    }
    ...
    public void setTelemetryProfile(TelemetryProfile obj) {
        ...
        telemetry_profile_refs.add(new ObjectReference<ApiPropertyBase>(obj.getQualifiedName(), null, null, obj.getUuid()));
    }
