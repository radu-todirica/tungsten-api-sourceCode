...
public class TelemetryProfile extends ApiObjectBase {
    ...
    public void setSflowProfile(SflowProfile obj) {
        ...
        sflow_profile_refs.add(new ObjectReference<ApiPropertyBase>(obj.getQualifiedName(), null, null, obj.getUuid()));
    }
    ...
    public void setGrpcProfile(GrpcProfile obj) {
        ...
        grpc_profile_refs.add(new ObjectReference<ApiPropertyBase>(obj.getQualifiedName(), null, null, obj.getUuid()));
    }
    ...
    public void setNetconfProfile(NetconfProfile obj) {
        ...
        netconf_profile_refs.add(new ObjectReference<ApiPropertyBase>(obj.getQualifiedName(), null, null, obj.getUuid()));
    }
    ...
    public void setSnmpProfile(SnmpProfile obj) {
        ...
        snmp_profile_refs.add(new ObjectReference<ApiPropertyBase>(obj.getQualifiedName(), null, null, obj.getUuid()));
    }
