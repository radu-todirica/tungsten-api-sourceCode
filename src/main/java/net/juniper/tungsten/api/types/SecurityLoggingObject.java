...
public class SecurityLoggingObject extends ApiObjectBase {
    ...
    public void setNetworkPolicy(NetworkPolicy obj, SecurityLoggingObjectRuleListType data) {
        ...
        network_policy_refs.add(new ObjectReference<SecurityLoggingObjectRuleListType>(obj.getQualifiedName(), data, null, obj.getUuid()));
    }
    ...
    public void setSecurityGroup(SecurityGroup obj, SecurityLoggingObjectRuleListType data) {
        ...
        security_group_refs.add(new ObjectReference<SecurityLoggingObjectRuleListType>(obj.getQualifiedName(), data, null, obj.getUuid()));
    }
