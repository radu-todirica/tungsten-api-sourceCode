...
public class InstanceIp extends ApiObjectBase {
    ...
    public void setNetworkIpam(NetworkIpam obj) {
        ...
        network_ipam_refs.add(new ObjectReference<ApiPropertyBase>(obj.getQualifiedName(), null, null, obj.getUuid()));
    }
    ...
    public void setLogicalInterface(LogicalInterface obj) {
        ...
        logical_interface_refs.add(new ObjectReference<ApiPropertyBase>(obj.getQualifiedName(), null, null, obj.getUuid()));
    }
    ...
    public void setFlowNode(FlowNode obj) {
        ...
        flow_node_refs.add(new ObjectReference<ApiPropertyBase>(obj.getQualifiedName(), null, null, obj.getUuid()));
    }
