...
public class AnalyticsSnmpNode extends ApiObjectBase {
    private String analytics_snmp_node_ip_address;
    ...
    public String getIpAddress() {
        return analytics_snmp_node_ip_address;
    }
    
    public void setIpAddress(String analytics_snmp_node_ip_address) {
        this.analytics_snmp_node_ip_address = analytics_snmp_node_ip_address;
    }
