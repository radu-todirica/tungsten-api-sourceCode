...
public class ApplicationPolicySet extends ApiObjectBase {
    ...
    public void setFirewallPolicy(FirewallPolicy obj, FirewallSequence data) {
        ...
        firewall_policy_refs.add(new ObjectReference<FirewallSequence>(obj.getQualifiedName(), data, null, obj.getUuid()));
    }
    ...
    public void setGlobalVrouterConfig(GlobalVrouterConfig obj) {
        ...
        global_vrouter_config_refs.add(new ObjectReference<ApiPropertyBase>(obj.getQualifiedName(), null, null, obj.getUuid()));
    }
