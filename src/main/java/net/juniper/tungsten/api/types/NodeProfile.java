...
public class NodeProfile extends ApiObjectBase {
    ...
    public void setJobTemplate(JobTemplate obj) {
        ...
        job_template_refs.add(new ObjectReference<ApiPropertyBase>(obj.getQualifiedName(), null, null, obj.getUuid()));
    }
    ...
    public void setHardware(Hardware obj) {
        ...
        hardware_refs.add(new ObjectReference<ApiPropertyBase>(obj.getQualifiedName(), null, null, obj.getUuid()));
    }
    ...
    public void setRoleDefinition(RoleDefinition obj) {
        ...
        role_definition_refs.add(new ObjectReference<ApiPropertyBase>(obj.getQualifiedName(), null, null, obj.getUuid()));
    }
