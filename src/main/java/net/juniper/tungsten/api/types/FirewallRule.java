...
public class FirewallRule extends ApiObjectBase {
    ...
    public void setServiceGroup(ServiceGroup obj) {
        ...
        service_group_refs.add(new ObjectReference<ApiPropertyBase>(obj.getQualifiedName(), null, null, obj.getUuid()));
    }
    ...
    public void setAddressGroup(AddressGroup obj) {
        ...
        address_group_refs.add(new ObjectReference<ApiPropertyBase>(obj.getQualifiedName(), null, null, obj.getUuid()));
    }
    ...
    public void setSecurityLoggingObject(SecurityLoggingObject obj, SloRateType data) {
        ...
        security_logging_object_refs.add(new ObjectReference<SloRateType>(obj.getQualifiedName(), data, null, obj.getUuid()));
    }
