...
public class VirtualMachineInterface extends ApiObjectBase {
    ...
    public void setSecurityLoggingObject(SecurityLoggingObject obj) {
        ...
        security_logging_object_refs.add(new ObjectReference<ApiPropertyBase>(obj.getQualifiedName(), null, null, obj.getUuid()));
    }
    ...
    public void setQosConfig(QosConfig obj) {
        ...
        qos_config_refs.add(new ObjectReference<ApiPropertyBase>(obj.getQualifiedName(), null, null, obj.getUuid()));
    }
    ...
    public void setSecurityGroup(SecurityGroup obj) {
        ...
        security_group_refs.add(new ObjectReference<ApiPropertyBase>(obj.getQualifiedName(), null, null, obj.getUuid()));
    }
    ...
    public void setVirtualMachine(VirtualMachine obj) {
        ...
        virtual_machine_refs.add(new ObjectReference<ApiPropertyBase>(obj.getQualifiedName(), null, null, obj.getUuid()));
    }
    ...
    public void setVirtualNetwork(VirtualNetwork obj) {
        ...
        virtual_network_refs.add(new ObjectReference<ApiPropertyBase>(obj.getQualifiedName(), null, null, obj.getUuid()));
    }
    ...
    public void setRoutingInstance(RoutingInstance obj, PolicyBasedForwardingRuleType data) {
        ...
        routing_instance_refs.add(new ObjectReference<PolicyBasedForwardingRuleType>(obj.getQualifiedName(), data, null, obj.getUuid()));
    }
    ...
    public void setBgpRouter(BgpRouter obj) {
        ...
        bgp_router_refs.add(new ObjectReference<ApiPropertyBase>(obj.getQualifiedName(), null, null, obj.getUuid()));
    }
    ...
    public void setPortTuple(PortTuple obj) {
        ...
        port_tuple_refs.add(new ObjectReference<ApiPropertyBase>(obj.getQualifiedName(), null, null, obj.getUuid()));
    }
    ...
    public void setServiceHealthCheck(ServiceHealthCheck obj) {
        ...
        service_health_check_refs.add(new ObjectReference<ApiPropertyBase>(obj.getQualifiedName(), null, null, obj.getUuid()));
    }
    ...
    public void setInterfaceRouteTable(InterfaceRouteTable obj) {
        ...
        interface_route_table_refs.add(new ObjectReference<ApiPropertyBase>(obj.getQualifiedName(), null, null, obj.getUuid()));
    }
    ...
    public void setPhysicalInterface(PhysicalInterface obj) {
        ...
        physical_interface_refs.add(new ObjectReference<ApiPropertyBase>(obj.getQualifiedName(), null, null, obj.getUuid()));
    }
    ...
    public void setBridgeDomain(BridgeDomain obj, BridgeDomainMembershipType data) {
        ...
        bridge_domain_refs.add(new ObjectReference<BridgeDomainMembershipType>(obj.getQualifiedName(), data, null, obj.getUuid()));
    }
    ...
    public void setServiceEndpoint(ServiceEndpoint obj) {
        ...
        service_endpoint_refs.add(new ObjectReference<ApiPropertyBase>(obj.getQualifiedName(), null, null, obj.getUuid()));
    }
    ...
    public void setPortProfile(PortProfile obj) {
        ...
        port_profile_refs.add(new ObjectReference<ApiPropertyBase>(obj.getQualifiedName(), null, null, obj.getUuid()));
    }
