...
public class WebuiNode extends ApiObjectBase {
    private String webui_node_ip_address;
    ...
    public String getIpAddress() {
        return webui_node_ip_address;
    }
    
    public void setIpAddress(String webui_node_ip_address) {
        this.webui_node_ip_address = webui_node_ip_address;
    }
