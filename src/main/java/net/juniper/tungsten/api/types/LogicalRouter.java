...
public class LogicalRouter extends ApiObjectBase {
    ...
    public void setRouteTarget(RouteTarget obj) {
        ...
        route_target_refs.add(new ObjectReference<ApiPropertyBase>(obj.getQualifiedName(), null, null, obj.getUuid()));
    }
    ...
    public void setVirtualNetwork(VirtualNetwork obj, LogicalRouterVirtualNetworkType data) {
        ...
        virtual_network_refs.add(new ObjectReference<LogicalRouterVirtualNetworkType>(obj.getQualifiedName(), data, null, obj.getUuid()));
    }
    ...
    public void setPhysicalRouter(PhysicalRouter obj) {
        ...
        physical_router_refs.add(new ObjectReference<ApiPropertyBase>(obj.getQualifiedName(), null, null, obj.getUuid()));
    }
