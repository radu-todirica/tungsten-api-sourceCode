...
public class ServiceGroup extends ApiObjectBase {
    private String draft_mode_state;
    private FirewallServiceGroupType service_group_firewall_service_list;
    ...
    public FirewallServiceGroupType getFirewallServiceList() {
        return service_group_firewall_service_list;
    }
    
    public void setFirewallServiceList(FirewallServiceGroupType service_group_firewall_service_list) {
        this.service_group_firewall_service_list = service_group_firewall_service_list;
    }
