...
public class VirtualRouter extends ApiObjectBase {
    ...
    public void setNetworkIpam(NetworkIpam obj, VirtualRouterNetworkIpamType data) {
        ...
        network_ipam_refs.add(new ObjectReference<VirtualRouterNetworkIpamType>(obj.getQualifiedName(), data, null, obj.getUuid()));
    }
    ...
    public void setSubCluster(SubCluster obj) {
        ...
        sub_cluster_refs.add(new ObjectReference<ApiPropertyBase>(obj.getQualifiedName(), null, null, obj.getUuid()));
    }
