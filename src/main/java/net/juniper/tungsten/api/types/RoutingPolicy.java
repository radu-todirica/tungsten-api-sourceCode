...
public class RoutingPolicy extends ApiObjectBase {
    ...
    private PolicyStatementType routing_policy_entries;
    ...
    public void setServiceInstance(ServiceInstance obj, RoutingPolicyServiceInstanceType data) {
        ...
        service_instance_refs.add(new ObjectReference<RoutingPolicyServiceInstanceType>(obj.getQualifiedName(), data, null, obj.getUuid()));
    }
    ...
    public PolicyStatementType getEntries() {
        return routing_policy_entries;
    }

    public void setEntries(PolicyStatementType routing_policy_entries) {
        this.routing_policy_entries = routing_policy_entries;
    }
}