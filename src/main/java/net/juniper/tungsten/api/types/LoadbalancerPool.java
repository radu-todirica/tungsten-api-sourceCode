...
public class LoadbalancerPool extends ApiObjectBase {
    ...
    public void setLoadbalancerListener(LoadbalancerListener obj) {
        ...
        loadbalancer_listener_refs.add(new ObjectReference<ApiPropertyBase>(obj.getQualifiedName(), null, null, obj.getUuid()));
    }
    ...
    public void setLoadbalancerHealthmonitor(LoadbalancerHealthmonitor obj) {
        ...
        loadbalancer_healthmonitor_refs.add(new ObjectReference<ApiPropertyBase>(obj.getQualifiedName(), null, null, obj.getUuid()));
    }
