...
public class VirtualNetwork extends ApiObjectBase {
    ...
    public void setNetworkIpam(NetworkIpam obj, VnSubnetsType data) {
        ...
        network_ipam_refs.add(new ObjectReference<VnSubnetsType>(obj.getQualifiedName(), data, null, obj.getUuid()));
    }
    ...
    public void setNetworkPolicy(NetworkPolicy obj, VirtualNetworkPolicyType data) {
        ...
        network_policy_refs.add(new ObjectReference<VirtualNetworkPolicyType>(obj.getQualifiedName(), data, null, obj.getUuid()));
    }
    ...
    public void setRouteTable(RouteTable obj) {
        ...
        route_table_refs.add(new ObjectReference<ApiPropertyBase>(obj.getQualifiedName(), null, null, obj.getUuid()));
    }
    ...
    public void setRoutingPolicy(RoutingPolicy obj) {
        ...
        routing_policy_refs.add(new ObjectReference<ApiPropertyBase>(obj.getQualifiedName(), null, null, obj.getUuid()));
    }
    ...
    public void setMulticastPolicy(MulticastPolicy obj) {
        ...
        multicast_policy_refs.add(new ObjectReference<ApiPropertyBase>(obj.getQualifiedName(), null, null, obj.getUuid()));
    }
    ...
    public void setBgpvpn(Bgpvpn obj) {
        ...
        bgpvpn_refs.add(new ObjectReference<ApiPropertyBase>(obj.getQualifiedName(), null, null, obj.getUuid()));
    }
    ...
    public void setIntentMap(IntentMap obj) {
        ...
        intent_map_refs.add(new ObjectReference<ApiPropertyBase>(obj.getQualifiedName(), null, null, obj.getUuid()));
    }
