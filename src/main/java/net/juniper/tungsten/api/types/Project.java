...
public class Project extends ApiObjectBase {
    ...
    public void setNamespace(Namespace obj, SubnetType data) {
        ...
        namespace_refs.add(new ObjectReference<SubnetType>(obj.getQualifiedName(), data, null, obj.getUuid()));
    }
    ...
    public void setFloatingIpPool(FloatingIpPool obj) {
        ...
        floating_ip_pool_refs.add(new ObjectReference<ApiPropertyBase>(obj.getQualifiedName(), null, null, obj.getUuid()));
    }
    ...
    public void setAliasIpPool(AliasIpPool obj) {
        ...
        alias_ip_pool_refs.add(new ObjectReference<ApiPropertyBase>(obj.getQualifiedName(), null, null, obj.getUuid()));
    }
    ...
    public void setApplicationPolicySet(ApplicationPolicySet obj) {
        ...
        application_policy_set_refs.add(new ObjectReference<ApiPropertyBase>(obj.getQualifiedName(), null, null, obj.getUuid()));
    }
