...
public class ServiceInstance extends ApiObjectBase {
    ...
    public void setServiceTemplate(ServiceTemplate obj) {
        ...
        service_template_refs.add(new ObjectReference<ApiPropertyBase>(obj.getQualifiedName(), null, null, obj.getUuid()));
    }
    ...
    public void setInstanceIp(InstanceIp obj, ServiceInterfaceTag data) {
        ...
        instance_ip_refs.add(new ObjectReference<ServiceInterfaceTag>(obj.getQualifiedName(), data, null, obj.getUuid()));
    }
