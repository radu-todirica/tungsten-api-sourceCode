...
public class ServiceEndpoint extends ApiObjectBase {
    ...
    public void setServiceConnectionModule(ServiceConnectionModule obj) {
        ...
        service_connection_module_refs.add(new ObjectReference<ApiPropertyBase>(obj.getQualifiedName(), null, null, obj.getUuid()));
    }
    ...
    public void setServiceObject(ServiceObject obj) {
        ...
        service_object_refs.add(new ObjectReference<ApiPropertyBase>(obj.getQualifiedName(), null, null, obj.getUuid()));
    }
